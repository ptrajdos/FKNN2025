...
class AttributeCombinationWeightEstimNBCrisp(AttributeCombinationWeightEstimNB):
    def __init__(
        self,
    ...
    def transform_attribute_weights(self, weights):
        ...
        col_idx = np.argmax(weights[variant_idx, row_idx], axis=1)

        transformed[variant_idx, row_idx, col_idx] = 1.0
