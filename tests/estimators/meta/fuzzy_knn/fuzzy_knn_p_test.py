...
class FuzzyKNNTest(unittest.TestCase):
    ...
    def get_estimators(self, channel_features) -> dict:
        ...
        return {
            "Default": FuzzyKNNP(channel_features=channel_features),
            "3NN": FuzzyKNNP(n_neighbors=3, channel_features=channel_features),
            "NoneNeigh": FuzzyKNNP(n_neighbors=None, channel_features=channel_features),
            "smoothstep": FuzzyKNNP(
